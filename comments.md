...
To enable or disable commenting, Journal Managers can visit the Content tab under Website Settings from the left sidebar. From here, check or uncheck the box next to Enable Public Comments and click “Save”.
...
![A sample comment showing a warning to the comment poster that reads "Your comment will be visible when the editor has approved".](./assets/comment-warning.png)


To manage comments in the moderation queue, navigate to Content in the left sidebar and select “Comments”.

![The comment moderation queue in OJS, showing a list of all comments made to the journal.](./assets/comment-menu.png)
...
![The more options menu expanded beside a comment needing approval, with options to view or delete the comment.](./assets/comment-more.png)

You can choose to instantly delete the comment using “Delete comment”, or select “View comment” to access other options.


![An expanded comment view, containing comment details as well as options to approve, delete, or hide the comment.](./assets/comment-view.png)
...
![An expanded comment view showing a report filed against the comment.](./assets/reported-comment.png)
