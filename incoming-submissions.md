...
> * If one or more Editors are [⇲assigned to the section](https://docs.pkp.sfu.ca/learning-ojs/journal-managers/en/policies#sections) the submission was made in, they will be automatically assigned to the submission and notified.
> * If one or more Editors are [⇲assigned to a category](https://docs.pkp.sfu.ca/learning-ojs/journal-managers/en/policies#categories) the submission was made in, they will be automatically assigned to the submission and notified.
...
![The more options menu expanded beside the Pre-check management task, with a cursor hovering over the Edit option.](./assets/precheck-edit.png)
